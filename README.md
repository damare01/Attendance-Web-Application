...
### 1. **User Registration for Attendance** {#user-registration-for-attendance}
...
### 2. **Dynamic Program List** {#dynamic-program-list}
...
### 3. **Form Submission and Data Recording** {#form-submission-and-data-recording}
...
### 4. **Automated Email Confirmation** {#automated-email-confirmation}
...
### 5. **Conditional Form Responses Based on `Attendance Open` Setting** {#conditional-form-responses-based-on-attendance-open-setting}
...
### 6. **Program-Specific Attendance Sheets** {#program-specific-attendance-sheets}
...
### 7. **Program Sheet with Full Program Name and Abbreviation** {#program-sheet-with-full-program-name-and-abbreviation}
